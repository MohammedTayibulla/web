...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hello, I am Mohammed Tayibulla.</span><br ></br>
        A passionate <span className="font-bold">Software Developer</span>
        {" "} building <span className="font-bold"> 💻Websites and 📱Applications</span>
      </motion.h1>
      ...
      >
        ...
        <a
          ...
          href="https://www.linkedin.com/in/mohammed-tayibulla-23619421b/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="https://github.com/mohammedtayibulla"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
